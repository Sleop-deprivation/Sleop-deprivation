...
function createLabelsAndButtons() {
    ...
    let startLabel1 = new PIXI.Text("Circle Blast ‼️");
    ...
    let startButton = new PIXI.Text("Enter... if you dare ‼️‼️‼️‼️");
    ...
    gameOverScoreLabel = new PIXI.Text("Your score is: "); 
...
function gameLoop(){
    ...
    // lerp (linear interpolate) the x and y values
	...
	for (let c of circles) {
        ...
        for (let b of bullets) {
            ...
            // Also check for bullets going out of bounds while we're here
            if (b.y < -10)
                b.isAlive = false;
        }
...
function fireBullet(e) {
    ...
    // Enable triple-fire at level 2+
    if (levelNum > 1) {
        let b2 = new Bullet(0xFFFFFF, ship.x - 20, ship.y + 12);
        bullets.push(b2);
        gameScene.addChild(b2);
        let b3 = new Bullet(0xFFFFFF, ship.x + 20, ship.y + 12);
        bullets.push(b3);
